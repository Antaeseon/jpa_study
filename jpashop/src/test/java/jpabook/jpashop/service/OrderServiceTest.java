...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertThat(1).as("주문 상품 종류 수가 정확해야 한다.").isEqualTo(getOrder.getOrderItems().size());
        assertThat(10000 * orderCount).as("주문 가격은 가격 * 수량이다.").isEqualTo(getOrder.getTotalPrice());
    ...
    public void 주문취소() throws Exception {
        ...
        assertThat(10).as("주문이 취소된 상품은 그만큼 재고가 증가해야 한다.")
                .isEqualTo(10);
    }
